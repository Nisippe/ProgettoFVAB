...
for video in videos:
    ...
    out = cv2.VideoWriter(
        'C:/Users/drugo/PycharmProjects/ProgettoFVAB/Video_Cut_Test/VID_RGB_CUT_' + str(indice) + '.mp4', codec,
...
for i in range(61,76):
    ...
    codec = cv2.VideoWriter_fourcc('m', 'p', '4', 'v')
    out = cv2.VideoWriter(
        'C:/Users/drugo/PycharmProjects/ProgettoFVAB/Video_Test_Landmarks/VID_RGB_CUT_' + str(i) + '.mp4', codec,
        fps, (int(width), int(height)))
